      ...
      {project && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-xl overflow-hidden rounded-xl border border-black/[0.08] bg-white/92 backdrop-blur-xl p-6 sm:p-8 shadow-2xl text-text-primary"
          >
